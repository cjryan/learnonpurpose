...
var _LearnOnPurpose$learnonpurpose$Lop$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	A2(
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('col s12 m9 l10'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$id('horizontal'),
														_1: {
															ctor: '::',
																...
																_0: A2(
																	...
																	},
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('card horizontal hoverable'),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
																				_0: A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$class('card-image main-page-card'),
																						_1: {ctor: '[]'}
																					},
																					{
																						ctor: '::',
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$class('red-text text-darken-1'),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text('26'),
																								_1: {ctor: '[]'}
																							}),
																						_1: {
																							ctor: '::',
																				...
																				_1: {
																					...
																					_0: A2(
																						...
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html_Attributes$class('card-stacked'),
																							_1: {ctor: '[]'}
																						},
																						{
																							ctor: '::',
																							_0: A2(
																								...
																								},
																								{
																									...
																									_0: A2(
																										...
																										{
																											ctor: '::',
																											_0: _elm_lang$html$Html_Attributes$class('grey-text text-darken-1'),
																											_1: {ctor: '[]'}
																										},
																										{
																											ctor: '::',
																											_0: _elm_lang$html$Html$text('Are cookies delicious?'),
																											_1: {ctor: '[]'}
																										}),
																									_1: {ctor: '[]'}
																								}),
																										...
																										_1: {
																											...
																											_1: {
																												...
																												_0: A2(
																													...
																													{
																														ctor: '::',
																														_0: _elm_lang$html$Html_Attributes$class('chip right'),
																														_1: {ctor: '[]'}
																													},
																													{
																														ctor: '::',
																														_0: A2(
																															...
																															{
																																ctor: '::',
																																_0: _elm_lang$html$Html$text('language 2'),
																																_1: {ctor: '[]'}
																															}),
																														_1: {ctor: '[]'}
																													}),
...
var Elm = {};
Elm['Lop'] = Elm['Lop'] || {};
if (typeof _LearnOnPurpose$learnonpurpose$Lop$main !== 'undefined') {
    _LearnOnPurpose$learnonpurpose$Lop$main(Elm['Lop'], 'Lop', undefined);
}
